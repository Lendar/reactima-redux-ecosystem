...
This is an attempt to find some core answers on Immutable.js related hype. Most performance issues can be solved not by algorithm but changing data structure. Functional approach tells a lot about functional composition and there are many examples with simple data objects which support approach over imperative programming. However what about big nested dataset? Memoization, immutability, streams, actors, etc concepts? All has to be sorted out somehow ...
